    ...
    then
        ...
        then
            ...
            then
                ...
                rbcli -e "${RB_EXP_DATE}" up "${OUTFILE}" "${ERRFILE}"  "${METAFILE}"
            else
                if test -z "${RBCLI_TAG}"
                then
                    rbcli up "${OUTFILE}" "${ERRFILE}""${METAFILE}"
                else
                    rbcli --tags "${RBCLI_TAG}" up "${OUTFILE}" "${ERRFILE}" "${METAFILE}"
                fi
            fi
        fi
    fi
